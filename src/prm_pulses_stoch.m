...
% N_pulses_epochs = ceil(orbit_arc_length/pulse_step) -1 - (ceil(pulse_offset/pulse_step))   
% N_pulses_epochs = fix(orbit_arc_length/pulse_step)+1 - (ceil(pulse_offset/pulse_step));  
N_pulses_epochs = ceil(orbit_arc_length/pulse_step) - (ceil(pulse_offset/pulse_step));   
