function [rms_orbital,rms_orbc,rms_orbk,rms_orbt,dstn,dorbc,dkepl,dorbt,orbce,orbte] = orbit_ext(orbc,orbk,orbt,veqZarray,veqParray,MODEid,cfg_fname)
...
if extorb_test == 'y'
    ...
    [orbte,orbce,orbke, ext_orbit_comp_yn] = prm_orbext(cfg_fname,GM_glob,eopdat,dpint);
    if write_out_flag > 0
