...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
orbit_model_struct.intersat_rangerate_empirical_01 = 0; 
[rangerate_empirical_struct] = prm_intersat_empirical (orbit_model_struct); 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
...
IC_CRF_sat1 = grace_pod_struct.grace1_pod.orbit_model.IC_CRF; 
IC_CRF_sat2 = grace_pod_struct.grace2_pod.orbit_model.IC_CRF; 
sat1_Xparam_aposteriori = IC_CRF_sat1(1,2:end)'; 
sat2_Xparam_aposteriori = IC_CRF_sat2(1,2:end)'; 
 
% Set to '0' to avoid updating force model via this call of grace_model_cor 
grav_param_01 = 0; 
...
% IC aposteriori update ::  
% Set to '0' to update IC 
% Set to '-1' to avoid update IC via this call of grace_model_cor 
Xmatrix_flag = 0;  
...
rangerate_empirical_parameters_apriori = rangerate_empirical_struct.rangerate_empirical_parameters; 
 
design_matrix_scale_orbit = 0;  
design_matrix_param_orbit = 0;  
NEQ_write = 0; 
[NEQ_N, NEQ_u, NEQ_N_reduced, NEQ_u_reduced, Xmatrix_orbit1, Xmatrix_orbit2, Xmatrix, Xcommon, Xcommon_NEQreduced, grace_pod_struct] = grace_comb_neq(grace_pod_struct, design_matrix_scale_orbit, design_matrix_param_orbit, NEQ_write, rangerate_empirical_struct); 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
 
% Xparam_aposteriori_orbit1_final = grace_pod_struct.grace1_pod.orbit_model.param_aposteriori 
% Xparam_aposteriori_orbit2_final = grace_pod_struct.grace2_pod.orbit_model.param_aposteriori 
% IC_orbit1_final = grace_pod_struct.grace1_pod.orbit_model.IC_CRF 
% IC_orbit2_final = grace_pod_struct.grace2_pod.orbit_model.IC_CRF 
 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
rangerate_empirical_struct = grace_pod_struct.rangerate_empirical_struct; 
rangerate_empirical_parameters_aposteriori = rangerate_empirical_struct.rangerate_empirical_parameters; 
% Next Iteration 
rangerate_empirical_parameters_apriori = rangerate_empirical_struct.rangerate_empirical_parameters; 
rangerate_empirical_struct.rangerate_empirical_function_01 = 0; 
 
% orbit_mission_grace_COMB_estimation_status = 'Next Iteration'; 
% rangerate_empirical_function_01 = rangerate_empirical_struct.rangerate_empirical_function_01 
 
% KBR_intersat_glob = orbit_model_struct.KBR_intersat_struct; 
% orbit_model_matrix_GRACE1.intersat_empirical = rangerate_empirical_struct; 
% orbit_model_matrix_GRACE2.intersat_empirical = rangerate_empirical_struct; 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
...
% orbital integration solution of Equation of motion and Variational Equations (orbit and partials)    
orbit_pod_mode = 'orbit_propagation_veq'; 
end 
