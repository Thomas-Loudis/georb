...
if SCALE_test == 1 
    ...
    Nparam = Nparam + 1; 
    alpha = acc_cal_param(Nparam,1); 
 
    Nparam = Nparam + 1; 
    beta = acc_cal_param(Nparam,1); 
     
    Nparam = Nparam + 1; 
    gama = acc_cal_param(Nparam,1); 
     
    Nparam = Nparam + 1; 
    delta  = acc_cal_param(Nparam,1); 
 
    Nparam = Nparam + 1; 
    epsilon = acc_cal_param(Nparam,1); 
     
    Nparam = Nparam + 1; 
    zeta = acc_cal_param(Nparam,1); 
