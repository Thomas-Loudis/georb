function [Xmatrix, Xmatrix_alt, bmatrix, Amatrix_out, Cx, Cy, NEQn, NEQu] = estimator_orbit (orbref,veqZarray,veqParray,orbobs,sigma_obs,inv_id) 
...
[Xmatrix, NEQn, NEQu, error_matrix, sigma0, Cx, Cy, Cv] = estimator_neq_sol(Amatrix_out, bmatrix, sigma_obs, inv_id); 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
% Cond_No_esitmator_orbit = cond(NEQn); 
