function [A_range, A_rangerate, A_orbit1, A_orbit2, grace_pod_struct] = grace_comb_veq2Amatrix(grace_pod_struct, design_matrix_scale_orbit, design_matrix_param_orbit, NEQ_write)
...
[Amatrix_rangerate_sat2, Amatrix_range_sat2] = neq_intersat_Amatrix(orbcGA,orbcGB, sat1_veqZ_matrix,sat1_veqP_matrix, sat2_veqZ_matrix,sat2_veqP_matrix, epochs_common); 
...
[Amatrix_obsorb_grace2] = neq_veq2Amatrix (sat2_veqZ_matrix, sat2_veqP_matrix, epochs_common, epochs_common);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% GRACE-3 matrices for combined estimator
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
epochs_common = orbcGA(:,1);
...
[Amatrix_rangerate_sat1, Amatrix_range_sat1] = neq_intersat_Amatrix(orbcGB,orbcGA, sat2_veqZ_matrix,sat2_veqP_matrix, sat1_veqZ_matrix,sat1_veqP_matrix, epochs_common); 
...
[Amatrix_obsorb_grace1] = neq_veq2Amatrix (sat1_veqZ_matrix, sat1_veqP_matrix, epochs_common, epochs_common);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% tol2 = rcond(NEQ_N);
% % Xmatrix3 = pinv(NEQ_N, tol2) * NEQ_u;
% Xmatrix3 = inv(NEQ_N) * NEQ_u; 
% % Xmatrix3 = lsqminnorm(NEQ_N, NEQ_u, tol2); 
% Xmatrix = Xmatrix3;
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 
