function [NEQn, NEQu] = estimator_neq(Amatrix, Wmatrix, sigma_obs) 
...
% % 
% % tol2 = rcond(NEQn);
% % Xmatrix5 = pinv(NEQn,tol2) * NEQu;
% % Xmatrix = Xmatrix5;
% 
% Xmatrix5 = inv(NEQn) * NEQu; 
% % delta_Xmatrix_pinv_tol_Function_estim_neq_sol = (Xmatrix5 - Xmatrix)'
% Xmatrix = Xmatrix5;
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 
% bmatrix = Wmatrix;
