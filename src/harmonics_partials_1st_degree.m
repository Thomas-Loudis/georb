function [potential_partials_rpl, potential_partials_xyz] = harmonics_partials_1st_degree(r,n_max,m_max,GM,ae,Cnm,Snm, legendre_functions_struct) 
...
n_max_harmonics_partials_1st_degree = n_max; 
