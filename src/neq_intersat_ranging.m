function [Amatrix_rangerate_out, Wmatrix_rangerate_out, Amatrix_range_out, Wmatrix_range_out, NEQ_range, NEQ_rangerate] = neq_intersat_ranging(orb1,orb2, veqZarray1,veqParray1, veqZarray2,veqParray2, intersat_obs, sigma_obs) 
